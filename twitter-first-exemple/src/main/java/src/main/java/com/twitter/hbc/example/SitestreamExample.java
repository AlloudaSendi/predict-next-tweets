...
public class SitestreamExample {
  ...
  public static void main(String[] args) {
    try {
      ...
      sitestreamExample.run("DJSBSUZZeMtSK7JnEenaza7X9", "QDJlOG2BUuGM2CtlivZYZn39pythhsatVlJIZszAXmk7a52LCQ", "796363170164207616-XaE0ZhQfUs08UpAZEYVhgyQDCPi3uMl", "3QG0OoSUcxeJlacjQponJNalzsmh8t9kZJly5cFlfbPBU");
